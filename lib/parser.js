...
module.exports = (function () {
    ...
    const unknownPageTag = Symbol("unknown");
    ...
    function parse(html) {
        const pageType = first(Object.getOwnPropertySymbols(matchers),
            (tag) => matchers[tag].test(html));
        const data = parsers[pageType] ? parsers[pageType](html) : null;
        return { type: pageType, data }
    }
